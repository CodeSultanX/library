...
@section('title')
    ...
    <!-- Title -->
    <title>{{__('Učenici | Online biblioteka')}}</title>
...
@section('content')
    ...
    <div style="display:none;" id="myDiv">
                ...
                <h1 style="font-size: 30px"
                    ...
                    @if (session()->has('success-student'))
                        <script>
                            swal({
                                title: "@lang('Uspješno!')",
                                text: "@lang('Uspješno ste dodali učenika!')",
                                timer: 2500,
                                type: "success",
                            });
                        </script>
                    ...
                    @if (session()->has('student-updated'))
                        <script>
                            swal({
                                title: "@lang('Uspješno!')",
                                text: "@lang('Uspješno ste izmijenili profil učenika!')",
                                timer: 2500,
                                type: "success",
                            });
                        </script>
                ...
                <div class="flex items-center justify-between px-[30px] py-4 space-x-3 rounded-lg">
                    <a href="{{ route('new-student') }}"
                       class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE]">
                        <i class="fas fa-plus mr-[15px]"></i> {{__('Novi učenik')}}
                    </a>
                    <div class="flex items-center">
                        ...
                        <form method="GET" action="{{ route('all-student') }}">
        ...
        <span class="absolute inset-y-0 left-0 flex items-center pl-2">
            ...
            <div
                ...
                @if (count($students) <= 0 && $show_criterium == false)
                    ...
                    <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                        ...
                        <p class="font-medium text-white">{{__('Trenutno nema registrovanih učenika!')}}</p>
                    </div>
            ...
            ">
                ...
                @if (count($students) > 0)
                    ...
                    <button type="submit"
                            class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] button delete-all-students"
                            data-url="">
                        <div class="icon">
                            <svg class="top">
                                <use xlink:href="#top">
                        ...
                        <tr class="border-[1px] border-[#e4dfdf]">
                            ...
                            <td class="px-3 py-5 leading-4 tracking-wider text-left sakriveno checkme2">
                                <button
                                    ...
                                    <span style="padding-top: 1px;">{{__('Izmijeni učenika')}}</span>
                                </button>
                            </td>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="py-1">
                                                ...
                                                <a
                                                    href="{{route('edit-student', $student->username)}}"
                                                    tabindex="0"
                                                    class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                                    role="menuitem">
                                                ...
                                                <button
                                                    ...
                                                    onclick="deleteConfirmation({{$student->id}})"
    ...
    <script type="text/javascript">
        function deleteConfirmation(id) {
            swal({
                title: "@lang('Izbriši?')",
                text: "@lang('Da li ste sigurni da želite da izbrišete učenika?')",
                type: "warning",
                showCancelButton: !0,
                timer: '5000',
                animation: true,
...
// window.location.href = "/bibliotekari";
        ...
        function showProfile() {
            ...
            window.location.href = "/ucenik/" + username;
        }

        // Script for edit student profile top header
        function editStudent() {
            var username = $('#check:checked').val();
            window.location.href = "/izmijeni-profil-ucenika/" + username;
        }
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.delete-all-students').on('click', function (e) {
                var idsArr = [];
                ...
                if (idsArr.length <= 0) {
                    ...
                    swal({
                        title: "@lang('Greška!')",
                        text: "@lang('Morate selektovati makar jednog učenika.')",
                        type: "error",
                        timer: 1500,
