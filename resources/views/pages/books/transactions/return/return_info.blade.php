...
<!-- Title -->
<title>{{__('Detalji vraćanja knjige | Online biblioteka')}}</title>
                ...
                <div
                    ...
                    <div class="absolute right-0 w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                        ...
                        <div class="py-1">
                            ...
                            <form action="{{route('destroy-book', $rent->book->id)}}"
                                  method="POST">
                                @csrf @honeypot
                                @method('DELETE')
        ...
        <div class="flex flex-row">
            <div class="inline-block w-full text-white text-right py-[7px] mr-[100px]">
                <button type="submit"
                    ...
                    <i class="fas fa-level-up-alt mr-[4px] "></i> Кітапты есептен шығару
                </button>
                <button type="submit"
                    ...
                    <i class="fas fa-redo-alt mr-[4px] "></i> Кітапты қайтару
                </button>
                <button type="button"
...
<div
    ...
    <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
        ...
        <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
            <h3>Da li zelite da vratite knjigu "Tom Sojer" za ucenika "Milos
                Milosevic"</h3>
        </div>
        <!-- Modal Body -->
...
<div
    ...
    <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
        <!-- Modal Header -->
        <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
            <h3>Da li zelite da otpisete knjigu "Tom Sojer" za ucenika "Milos
                Milosevic?"</h3>
        </div>
        <!-- Modal Body -->
        <div class="flex items-center justify-end px-[30px] py-[20px] border-t w-100 text-white">
...
<div
    ...
    <div class="w-[500px] bg-white rounded shadow-lg md:w-1/3">
        <!-- Modal Header -->
        <div class="flex items-center justify-between px-[30px] py-[20px] border-b">
            <h3>Da li zelite da izbrisete zapis knjige "Tom Sojer" za ucenika
                "Milos Milosevic?"</h3>
        </div>
        <!-- Modal Body -->
        <div class="flex items-center justify-end px-[30px] py-[20px] border-t w-100 text-white">
