...
<!-- Title -->
<title>{{__('Кітапты қайтару | Online biblioteka')}}</title>
                    ...
                    <div>
                        <nav class="w-full rounded">
                            <ol class="flex list-reset">
                                ...
                                <li>
                                    <a href="{{route('return-book', $get_book->title)}}"
                                       class="text-[#2196f3] hover:text-blue-600">
                                        Кітапты қайтару
                                    </a>
                                </li>
            ...
            <div class="pt-[24px] mr-[30px]">
                ...
                <div
                    ...
                    <div class="absolute right-0 w-56 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                        ...
                        <div class="py-1">
                            <a href="{{route('edit-book', $get_book->title)}}"
                               tabindex="0"
                            ...
                            <form action="{{route('destroy-book', $get_book->id)}}"
                                  method="POST">
                                @csrf
                                @method('DELETE')
                                <button
    ...
    <div class="scroll height-dashboard px-[30px]">
        ...
        <div
            ...
            <form action="{{route('store-return-book')}}" method="POST">
                ...
                <table class="min-w-full border-[1px] border-[#e4dfdf]"
                       id="vratiKnjiguTable">
                    ...
                    <tr class="border-b-[1px] border-[#e4dfdf]">
                        <th class="px-4 py-3 leading-4 tracking-wider text-left text-blue-500">
                            <label class="inline-flex items-center">
                                <input type="checkbox"
                                       class="select-all form-checkbox">
                            </label>
                        </th>
                    ...
                    <tr class="border-b-[1px] border-[#e4dfdf]">
                        ...
                        <td class="flex flex-row items-center px-4 py-4">
                            <img class="object-cover w-8 h-8 mr-2 rounded-full"
                                 src="{{$rent->rent->borrow->photo == 'placeholder' ? '/img/profileImg-default.jpg' : '/storage/students/' . $rent->rent->borrow->photo}}"
                        ...
                        <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">
                            @php
                            echo date("d-m-Y",
                            strtotime($rent->rent->issue_date));
                            @endphp
                        </td>
                        <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">
                        <span>
                            ...
                            <?php
                            if ($variable->value % 10 == 1
                                || $variable->value % 10 == 11
                                || $variable->value == 1
                            ) {
                                $day = "dan";
                            } else {
                            ...
                            $datetime1
                                = new DateTime(($rent->rent->issue_date));
                            $datetime2
                                = new DateTime(($rent->rent->return_date));
        ...
        <div class="mx-[50px]">
            <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                ...
                <p class="font-medium text-white">Trenutno nema izdatih knjiga
                    za vraćanje! </p>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-row">
            <div class="inline-block w-full text-right py-[7px] mr-[100px] text-white">
                ...
                <button type="submit"
                        ...
                        disabled>
                    Кітапты қайтару <i class="fas fa-check ml-[4px]"></i>
                </button>
                </form>
            </div>
        </div>
