                ...
                <div class="pl-[30px] section- mt-[20px]">
                    <div class="flex flex-row justify-between">
                        <div class="mr-[30px]">
                            ...
                            <div class="mt-[40px]">
                                <span
                                    class="text-gray-500">{{$reservation->made_by->gender->id == 1 ? 'Bibliotekar' : 'Bibliotekarka'}}</span>
                            ...
                            <div class="mt-[40px]">
                                <span
                                    class="text-gray-500">{{$reservation->made_for->gender->id == 1 ? 'Učenik' : 'Učenica'}}</span>
