                    ...
                    <div class="py-1">
                        ...
                        <a href="{{route('return-book', $book->rent->book->title)}}" tabindex="0"
                           ...
                           role="menuitem">
                            ...
                            <span class="px-4 py-0">Кітапты қайтару</span>
                        </a>
                        ...
                        <a href="{{route('write-off', $book->rent->book->title)}}" tabindex="0"
                           ...
                           role="menuitem">
                            ...
                            <span class="px-4 py-0">Кітапты есептен шығару</span>
                        </a>
...
@endif
                            ...
                            <div class="mx-[50px]">
                                <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                                    ...
                                    <p class="font-medium text-white">{{__('Trenutno nema izdatih knjiga!')}}</p>
                                </div>
                            </div>
                            ...
                            <div class="mx-[50px]">
                                <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                                    ...
                                    <p class="font-medium text-white">{{__('Trenutno nema rezultata za traženi kriterijum!')}}</p>
                                </div>
                            </div>
