...
<!-- Title -->
<title>{{__('Arhivirane rezervacije | Online biblioteka')}}</title>
                ...
                <table class="shadow-lg rounded-xl w-full border-[1px] border-[#e4dfdf] rezervacije"
                    ...
                    <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                        ...
                        <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                            @php
                            echo date("d-m-Y",
                            strtotime($reservation->reservation->reservation_date));
                            @endphp
                        </td>
                        <td class="px-4 py-3 text-sm leading-5 whitespace-no-wrap">
                            @php
                            echo date("d-m-Y",
                            strtotime($reservation->reservation->request_date));
                            @endphp
                        </td>
                        <td class="flex flex-row items-center px-4 py-3">
                            <img
                            ...
                            <a href="{{route('show-student', $reservation->reservation->made_for->username)}}"
                               class="ml-2 font-medium text-center">{{$reservation->reservation->made_for->name}}</a>
                        </td>
                        ...
                        <td class="px-4 py-3 text-sm leading-5 text-right whitespace-no-wrap">
                            ...
                            <div
                                ...
                                <div class="absolute right-0 w-56 mt-2 origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                    ...
                                    <div class="py-1">
                                        <a href="{{route('rent-book', $reservation->reservation->book->title)}}"
                                           tabindex="0"
                                           class="flex w-full px-4 py-2 text-sm leading-5 text-left text-gray-700 outline-none hover:text-blue-600"
                                           role="menuitem">
                                            <i class="far fa-hand-scissors mr-[10px] ml-[5px] py-1"></i>
                                            <span class="px-4 py-0">Кітап шығару</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="mx-[50px]">
                        <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                            ...
                            <p class="font-medium text-white">{{__('Trenutno nema arhiviranih rezervacija!')}}</p>
                        </div>
                    </div>
