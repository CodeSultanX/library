...
<main class="flex flex-row small:hidden">
    ...
    <section class="w-screen h-screen pl-[80px] pb-2 text-gray-700">
        ...
        <div class="flex flex-row overflow-auto height-osnovniDetalji">
            <div class="w-[80%]">
                <div class="">
                    <x-books.show_components.holder :book="$book"
                                                    :rents="$rents"></x-books.show_components.holder>
                </div>
            </div>
            <div id="hideBookMenu"
                 class="min-w-[20%] border-l-[1px] border-[#e4dfdf]"
                    ...
                    <div class="ml-[30px] mr-[70px] mt-[20px] flex flex-row justify-between">
                        ...
                        <div class="text-center pb-[30px]">
                            <p class=" bg-green-200 text-green-700 rounded-[10px] px-[6px] py-[2px] text-[14px]">
                                ...
                                ($book->rented_count + $book->reserved_count)) %
                                10 == 2 || ($book->quantity_count -
                                ($book->rented_count + $book->reserved_count)) %
                                10 == 3 || ($book->quantity_count -
                                ($book->rented_count + $book->reserved_count)) %
                                10 == 4) {
                                echo "primjerka";
                                } else {
                            ...
                            <a href="{{route('active-reservations')}}"><p
                                    ...
                                    $book->reserved_count == 1) {
                                    echo "primjerak";
                                    } elseif ($book->reserved_count % 10 == 2 ||
