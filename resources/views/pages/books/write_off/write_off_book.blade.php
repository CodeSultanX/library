...
@section('title')
    ...
    <!-- Title -->
    <title>Кітапты есептен шығару | Online biblioteka</title>
            ...
            <div
                ...
                <form action="{{route('update-write-off', $book->id)}}" method="POST">
                    ...
                    @if ($count > 0)
                        ...
                        <table class="min-w-full border-[1px] border-[#e4dfdf]" id="vratiKnjiguTable">
                            ...
                            @if (session()->has('write-off'))
                                <div id="hideDiv"
                                     class="flex p-4 mt-2 mb-1 text-sm text-green-700 bg-green-200 rounded-lg dark:bg-green-200 dark:text-green-800"
                                     role="alert">
                            ...
                            @foreach ($book->rent->where('return_date', '<', now()) as $rent)
                                ...
                                <tr class="border-b-[1px] border-[#e4dfdf]">
                                    <td class="px-4 py-4 whitespace-no-wrap">
                                        <label class="inline-flex items-center">
                                            <input type="checkbox" class="form-checkbox" value="{{$rent->borrow->id}}"
                                                   name="checkbox[]">
                                        </label>
                                    </td>
                                    <td class="flex flex-row items-center px-4 py-4">
                                        <img class="object-cover w-8 h-8 mr-2 rounded-full"
                                             src="{{$rent->borrow->photo == 'placeholder' ? '/img/profileImg-default.jpg' : '/storage/students/' . $rent->borrow->photo}}"
                    ...
                    <span style="color: #2A4AB3">
                        ...
                        {{$variable}}
                        @php
                            if ($variable % 10 == 1 && $variable != 11 && $variable != 111) {
                            echo "dan";
                            } else {
                            echo "dana";
                            }
            ...
            <div class="flex flex-row">
                <div class="inline-block w-full text-right py-[7px] mr-[100px] text-white">
                    ...
                    <button type="submit"
                            ...
                            disabled>
                            Кітапты есептен шығару <i class="fas fa-check ml-[4px]"></i>
                    </button>
                    </form>
                </div>
            </div>
