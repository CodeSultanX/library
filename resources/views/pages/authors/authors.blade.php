...
@section('title')
    ...
    <!-- Title -->
    <title>{{__('Autori | Online biblioteka')}}</title>
...
@section('content')
        ...
        <section class="w-screen h-screen pl-[80px] py-4 text-gray-700">
                        ...
                        <h1 style="font-size: 30px">
                            ...
                            @if (session()->has('success-author'))
                                <script>
                                    swal({
                                        title: "@lang('Uspješno!')",
                                        text: "@lang('Uspješno ste dodali autora!')",
                                        timer: 2500,
                                        type: "success",
                                    });
                                </script>
                            ...
                            @if (session()->has('author-updated'))
                                <script>
                                    swal({
                                        title: "@lang('Uspješno!')",
                                        text: "@lang('Uspješno ste izmijenili autora!')",
                                        timer: 2500,
                                        type: "success",
                                    });
                                </script>
                ...
                <div class="flex items-center px-[30px] py-4 space-x-3 rounded-lg justify-between">
                    <a href="{{route('new-author')}}"
                       class="btn-animation inline-flex items-center text-sm py-2.5 px-5 transition duration-300 ease-in rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE]">
                        <i class="fas fa-plus mr-[15px]"></i> {{__('Novi autor')}}
                    </a>
                    <div class="flex items-center">
                        ...
                        <script>
                            document.getElementById('pagination').onchange = function () {
                                window.location = "{{ $authors->url(1) }}&items=" + this.value;
                            };
                        </script>
                        <form method="GET" action="{{ route('all-author') }}">
            ...
            <div
                ...
                @if (count($authors) > 0)
                    ...
                    <button type="submit"
                            class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE] button delete-all-authors"
                            data-url="">
                        <div class="icon">
                            <svg class="top">
                                <use xlink:href="#top">
                    ...
                    <table id="sort"
                           class="overflow shadow-lg rounded-xl min-w-full border-[1px] border-[#e4dfdf]"
                           id="myTable">
                        ...
                        <tr class="border-b-[1px] border-[#e4dfdf]">
                            ...
                            <td class="px-3 py-5 leading-4 tracking-wider text-left sakriveno checkme2">
                                <button
                                    ...
                                    <span style="padding-top: 1px;">{{__('Izmijeni autora')}}</span>
                                </button>
                            </td>
                            ...
                            <td style="width: 180px;"
                                ...
                                <button
                                    ...
                                    <span style="padding-top: 1px;">{{__('Izbriši autora')}}</span>
                                </button>
                            </td>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="py-1">
                                                ...
                                                <button
                                                    data-id="{{ $author->id }}"
                                                    data-action="{{ route('authors.destroy', $author->id) }}"
                                                    onclick="deleteConfirmation({{$author->id}})"
                    ...
                    <div class="m-3">{!! $authors->links() !!}</div>
    ...
    @elseif ($show_criterium == false)
        ...
        <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
            ...
            <p class="font-medium text-white">{{__('Trenutno nema autora u bazi podataka!')}}</p>
        </div>
