...
@section('title')
    ...
    <!-- Title -->
    <title>{{__('Әкімшілер / онлайн кітапхана')}}</title>
...
@section('content')
    ...
    <div style="display:none;" id="myDiv">
                ...
                <h1 style="font-size: 30px"
                    ...
                    @if (session()->has('success-admin'))
                        <script>
                            swal({
                                title: "@lang('Uspješno!')",
                                text: "@lang('Uspješno ste dodali administratora!')",
                                timer: 2500,
                                type: "success",
                            });
                        </script>
                    ...
                    @if (session()->has('admin-updated'))
                        <script>
                            swal({
                                title: "@lang('Uspješno!')",
                                text: "@lang('Uspješno ste izmijenili administratora!')",
                                timer: 2500,
                                type: "success",
                            });
                        </script>
                ...
                <div class="flex items-center justify-between px-[30px] py-4 space-x-3 rounded-lg">
                    <a href="{{ route('new-admin') }}"
                       class="btn-animation inline-flex items-center text-sm py-2.5 px-5 rounded-[5px] tracking-wider text-white bg-[#3f51b5] hover:bg-[#4558BE]">
                        <i class="fas fa-plus mr-[15px]"></i> {{__('Жаңа әкімші')}}
                    </a>
        ...
        <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                ...
                @if (count($administrators) <= 0 && $show_criterium == false)
                    ...
                    <div class="w-[400px] flex items-center px-6 py-4 my-4 text-lg bg-[#3f51b5] rounded-lg">
                        ...
                        <p class="font-medium text-white">
                            {{__('Қазіргі уақытта тіркелген әкімшілер жоқ!')}}
                        </p>
                    </div>
            ...
            ">
                        ...
                        <p class="font-medium text-white">{{__('Қазіргі уақытта нәтиже жоқ
                    ')}} "{{$searched}}".. &#128533;</p>
                    </div>
                    <a
                        ...
                        href="{{route('all-admin')}}"><i
                            class="fas fa-arrow-left mr-[5px]"></i>{{__('Артқа')}}</a>
                @endif
                    ...
                    <table id="sort"
                        ...
                        <tr class="border-[1px] border-[#e4dfdf]">
                            ...
                            <td style="width: 180px"
                                ...
                                <button
                                    ...
                                    <span style="padding-top: 1px;">{{__('Мәліметтерді қараңыз')}}</span>
                                </button>
                            </td>
                            ...
                            <td class="px-3 py-5 leading-4 tracking-wider text-left sakriveno checkme2">
                                <button
                                    ...
                                    <span style="padding-top: 1px;">{{__('Әкімшіні өзгерту')}}</span>
                                </button>
                            </td>
                            ...
                            <th class="px-4 py-4 leading-4 tracking-wider text-left changeme"
                                id="arrow">
                                {{__('Жүйеге соңғы қол жетімділік')}}
                            </th>
                        ...
                        @foreach ($administrators as $admin)
                            <tr class="hover:bg-gray-200 hover:shadow-md border-b-[1px] border-[#e4dfdf]">
                                ...
                                <td class="px-4 py-4 text-sm leading-5 whitespace-no-wrap">
                                    {{$admin->login_count == 0 ? __('Пайдаланушы ешқашан жүйеге кірмеген.') : $admin->last_login_at->diffForHumans()}}
                                </td>
                                <td class="px-4 py-4 text-sm leading-5 text-right whitespace-no-wrap">
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="absolute right-[25px] w-16 mt-[7px] origin-top-right bg-white border border-gray-200 divide-y divide-gray-100 rounded-md shadow-lg outline-none"
                                            ...
                                            <div class="py-1">
                                                <a href="{{route('show-admin', $admin->username)}}"
                                                   ...
                                                   role="menuitem">
                                                    ...
                                                    <span class="px-4 py-0">{{__('Мәліметтерді қараңыз')}}</span>
                                                </a>
    ...
    <script type="text/javascript">
        function deleteConfirmation(id) {
            swal({
                title: "@lang('Izbriši?')",
                text: "@lang('Da li ste sigurni da želite da izbrišete administratora?')",
                type: "warning",
                showCancelButton: !0,
                timer: '5000',
                animation: true,
