<nav id="sidebar"
    ...
    <div class="">
        ...
        <div
            ...
            <i id="hamburger"
               class="cursor-pointer hamburger-btn fas fa-bars"></i>
        </div>
        <div class="mt-[30px]">
            <ul class="text-[#2D3B48] sidebar-nav">
                ...
                <li class="pt-[18px] pb-[14px] mb-[4px] group hover:bg-[#EAEAEA] h-[60px]">
                    <div class="ml-[30px]">
                        <span class="flex justify-between w-full whitespace-nowrap">
                            <div>
                                <a href="{{route('recom-books')}}"
                                   aria-label="Knjige_us">
                                    <i
                                            style="font-size: 25px"
                                            class="{{ (request()->is('knjige_us')) ? 'text-[25px]
                                    far fa-thumbs-up transition duration-300 ease-in text-[#576cdf]' : 'text-[25px] text-[#707070] far fa-thumbs-up transition duration-300 ease-in group-hover:text-[#576cdf]'}}"></i>
                                    <div class="hidden sidebar-item">
                                        <p class=" inline text-[15px] ml-[20px] transition duration-300 ease-in group-hover:text-[#576cdf]">
                                            {{__('Knjige_us')}}
                                        </p>
                            ...
                            <div>
                                <a href="#" id="btnFullscreen"
                                   aria-label="Fullscreen">
                                    ...
                                    <i id="expand2"
                                       class="hidden_expand transition duration-300 ease-in group-hover:text-[#576cdf] text-[25px] text-[#707070] fas fa-compress-alt"></i>
    ...
    <div class="sidebar-nav py-[10px] border-t-[1px] border-[#e4dfdf] pt-[23px] pb-[29px] group hover:bg-[#EFF3F6]">
        <!-- Settings Icon -->
        <a id="gear_text" href="{{route('setting-policy')}}"
           aria-label="Podešavanja" class="ml-[30px]">
            <span class="whitespace-nowrap">
                <i id="gear"
                   class="{{(request()->is('podesavanja/*')) ? 'text-[25px] fas fa-cog transition duration-300 ease-in text-[#576cdf]' : 'text-[25px] text-[#707070] fas fa-cog transition duration-300 ease-in group-hover:text-[#576cdf]'}}"></i>
