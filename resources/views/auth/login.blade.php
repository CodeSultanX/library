<!DOCTYPE html>
<html lang="en">
<head><title>{{__('Кіру / онлайн кітапхана')}}</title>
    ...
    <div class="flex items-center justify-center pt-[13%]">
        <div class="w-full max-w-md">
            <form class="px-12 pt-6 pb-4 mb-4 bg-white rounded shadow-lg"
                ...
                Онлайн кітапхана <img height="5px" width="34px"
                                           class="ml-2"
                ...
                <div class="mb-6"><label
                            ...
                            for="password"> Құпия сөз </label> <input
                        ...
                        <input id="remember_me" type="checkbox"
                               ...
                               name="remember"> <span
                                class="ml-2 text-sm text-gray-600 no-select">{{__('Сақтау')}}</span>
                    </label></div>
                <div class="flex items-center justify-between">
                    ...
                    @if (Route::has('password.request')) <a
                            ...
                            href="{{route( 'password.request')}}">Құпия сөзді ұмыттыңыз ба? </a> @endif </div>
                <p class="text-xs text-center mt-[30px] text-gray-500 "> &copy;
                    @php echo date('Y') @endphp Жоба 2023 </p></form>
        </div>
    </div>
</main>
